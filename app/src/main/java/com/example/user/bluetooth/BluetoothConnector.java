package com.example.user.opencv_app1.bluetooth;
...
import com.example.user.opencv_app1.bluetooth.exception.ConnectionBluetoothException;
import com.example.user.opencv_app1.bluetooth.exception.NotSupportedBluetoothException;
